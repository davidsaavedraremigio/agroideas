{!! Form::open(array('id'=>'FormCreateEntidadCooperante','url'=>'de/convenio-cooperante','method'=>'POST','autocomplete'=>'off')) !!}
<div class="modal-header">
    <h4 class="modal-title">Registrar Cooperante</h4>
...
<div class="modal-body">
    ...
    <div id="EntidadCooperanteAlerts" class="alert alert-danger" style="display: none;"></div>
    {{-- Panel para mostrar alertas --}}
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-4">{!! Form::label('tipo', 'Tipo de entidad') !!} {!! Form::text('tipo', '', ['class' => 'form-control', 'id' => 'input_tipo_entidad', 'readonly' => 'readonly']) !!}</div>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-8">{!! Form::label('cargo', 'Cargo que desempeña') !!} {!! Form::text('cargo', '', ['class' => 'form-control']) !!}</div>
        </div>
    </div>
</div>
<div class="modal-footer justify-content-between">
    <div id="Footer_CreateEntidadCooperante_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnCreateEntidadCooperante" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_CreateEntidadCooperante_Disabled" style="display:none;">
