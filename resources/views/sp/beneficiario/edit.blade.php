{!!Form::model($productor,['id'=>'FormUpdateBeneficiario', 'method'=>'PATCH', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['beneficiario.update',$productor->id]])!!}
...
<div class="modal-body">
    ...
    <div id="BeneficiarioAlerts" class="alert alert-danger" style="display: none;"></div>
    {{-- Panel para mostrar alertas --}}
    ...
    <div class="form-group">
       <div class="row">
            <div class="col-md-6">{!! Form::label('fecha', 'Fecha de nacimiento') !!} {!! Form::date('fecha', $persona->fechaNacimiento, ['class' => 'form-control', 'placeholder' => 'yyyy-mm-dd', 'min' => $minDate, 'max' => $maxDate]) !!}</div>
            <div class="col-md-6">{!! Form::label('sexo', 'Sexo') !!} 
...
<div class="modal-footer justify-content-between">
    <div id="Footer_UpdateBeneficiario_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnUpdateBeneficiario" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_UpdateBeneficiario_Disabled" style="display:none;">
