{!! Form::open(array('id'=>'FormCreateBeneficiario','url'=>'sp/beneficiario','method'=>'POST','autocomplete'=>'off')) !!}
...
<div class="modal-body">
    ...
    {{-- Panel para mostrar alertas --}}
    <input type="hidden" name="codEntidad" value="{{$idProyecto}}">
    ...
    <div class="form-group">
       <div class="row">
            <div class="col-md-6">{!! Form::label('fecha', 'Fecha de nacimiento') !!} {!! Form::date('fecha', '', ['class' => 'form-control', 'placeholder' => 'yyyy-mm-dd', 'min' => $minDate, 'max' => $maxDate]) !!}</div>
...
<div class="modal-footer justify-content-between">
    <div id="Footer_CreateBeneficiario_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnCreateBeneficiario" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_CreateBeneficiario_Disabled" style="display:none;">
