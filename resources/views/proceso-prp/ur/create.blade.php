{!! Form::open(array('id'=>'FormCreateExpedienteUR','url'=>'proceso-prp/ur','method'=>'POST','autocomplete'=>'off')) !!}
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-8">{!! Form::label('entidad', 'Seleccione un PRP de la lista') !!}
...
<div class="modal-footer justify-content-between">
    <div id="Footer_CreateExpedienteUR_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnCreateExpedienteUR" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_CreateExpedienteUR_Disabled" style="display:none;">
