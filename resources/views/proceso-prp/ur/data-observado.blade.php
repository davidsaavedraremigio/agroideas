<table id="TablaObservado" class="table table-sm table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-justify"><small>{{$fila->especialista_asignado}}</small></td>
            <td class="text-center"><small>{{$fila->nro_informe_observa}}</small></td>
            <td class="text-center"><small>{{$fila->nro_carta_observa}}</small></td>
            <td class="text-center"><small>{{ \Carbon\Carbon::parse($fila->fecha_carta_observa)->format('d/m/Y')}}</small></td>
            <td class="text-center {{$fila->bg_color}}"><small>{{$fila->nro_dias_observado}}</small></td>
            <td class="text-center">
                <a href="#" class="btn btn-sm btn-default" id="btnmodalSubsanaObservacionUR" data-toggle="modal" data-target="#modalSubsanaObservacionUR" data-id="{{$fila->id}}" title="Subsana observaciones"><i class="fas fa-clipboard-check"></i></a>
