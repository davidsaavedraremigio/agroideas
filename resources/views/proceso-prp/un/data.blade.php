<table id="TablaExpediente" class="table table-striped table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center {{$fila->bg_color}}"><small>{{$fila->nro_dias}}</small></td>
            <td class="text-center">
                <a href="#" class="btn btn-sm btn-success" id="btnmodalCreateExpedienteUn" data-toggle="modal" data-target="#modalCreateExpedienteUn" data-id="{{$fila->codExpediente}}" title="Recepcionar expediente"><i class="fas fa-inbox"></i></a>
                <a href="#" class="btn btn-sm btn-warning" id="btnmodalObservaExpedienteUn" data-toggle="modal" data-target="#modalObservaExpedienteUn" data-id="{{$fila->codExpediente}}" title="Devolver con observaciones"><i class="fas fa-exclamation-circle"></i></a>
                <!--<a href="#" class="btn btn-sm btn-danger" id="btnmodalArchivaExpedienteUn" data-toggle="modal" data-target="#modalArchivaExpedienteUn" data-id="{{$fila->codExpediente}}" title="Archivar expediente"><i class="fas fa-thumbs-down"></i></a>-->
                <a href="#" class="btn btn-sm btn-primary" id="btnmodalDerivaExpedienteUn" data-toggle="modal" data-target="#modalDerivaExpedienteUn" data-id="{{$fila->codExpediente}}" title="Derivar expediente"><i class="fas fa-paper-plane"></i></a>
            </td>
        </tr>   
        @endforeach
    </tbody>
