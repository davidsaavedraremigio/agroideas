{!!Form::model($expediente,['id'=>'FormArchivaExpedienteUn', 'method'=>'POST', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['un.procesa-archivo',$expediente->id]])!!}
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-4">{!! Form::label('nro_carta', 'Nº Memorándun') !!} {!! Form::number('nro_carta', $un->nro_carta_archivo, ['class' => 'form-control']) !!}</div>
            <div class="col-md-4">{!! Form::label('fecha_carta', 'Fecha') !!} {!! Form::date('fecha_carta', $un->fecha_carta_archivo, ['class' => 'form-control', 'max' => date('Y-m-d')]) !!}</div>
        </div>
    </div>    
</div>
