...
@section('title', 'Módulo para la evaluación de PRPA - UN')
@section('content')
...
<script>
    $(document).ready(function () {
        ...
        $("#viewDataExpedienteUn").load("un/data-pendiente");
        ...
        $("#viewDataExpedienteUnAprobado").load("un/data-aprobado");
        ...
        $("#viewDataExpedienteUnObservado").load("un/data-observado");
        ...
        $("#viewDataExpedienteUnArchivado").load("un/data-archivado");
        ...
        $('#modalCreateExpedienteUn').on('show.bs.modal', function (e) {
            ...
            $('#divFormCreateExpedienteUn').load("un/"+idExpediente+"/create");
        });
        ...
        $('#modalDerivaExpedienteUn').on('show.bs.modal', function (e) {
            var idExpediente = $(e.relatedTarget).attr('data-id');
            $('#divFormDerivaExpedienteUn').load('un/' + idExpediente + '/informe');
        });
        ...
        $('#modalObservaExpedienteUn').on('show.bs.modal', function (e) {
            var idExpediente = $(e.relatedTarget).attr('data-id');
            $('#divFormObservaExpedienteUn').load('un/' + idExpediente + '/observa');
        });
        $(document).on("click", '#btnObservaExpedienteUn', function (event) {
            ...
            $.ajax({
                ...
                error: function (response) {
                    ...
                    $("#Footer_ObservaExpedienteUn_Enabled").css("display", "block");
                    $("#Footer_ObbservaExpedienteUn_Disabled").css("display", "none");
                }
            });
        });
        ...
        $('#modalArchivaExpedienteUn').on('show.bs.modal', function (e) {
            var idExpediente = $(e.relatedTarget).attr('data-id');
            $('#divFormArchivaExpedienteUn').load('un/' + idExpediente + '/archiva');
        });
