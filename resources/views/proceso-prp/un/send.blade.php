{!!Form::model($expediente,['id'=>'FormDerivaExpedienteUn', 'method'=>'POST', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['un.procesa-informe',$expediente->id]])!!}
<div class="modal-header">
    <h4 class="modal-title">Derivar Expediente PRPA</h4>
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12"><label for="">DERIVACIÓN DE EXPEDIENTE A LA UNIDAD DE ASESORÍA LEGAL</label></div>
        </div>
        <div class="row">
            <div class="col-md-8">{!! Form::label('especialista', 'Especialista responsable') !!} 
            ...
            <div class="col-md-4">{!! Form::label('fecha_derivacion', 'Fecha de derivacion') !!} {!! Form::date('fecha_derivacion', $un->fecha_derivacion, ['class' => 'form-control', 'max' => date('Y-m-d')]) !!}</div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-md-4">{!! Form::label('nro_informe', 'Nº informe') !!} {!! Form::number('nro_informe', $un->nro_informe, ['class' => 'form-control', 'min' => '1', 'max' => '9999']) !!}</div>
            <div class="col-md-4">{!! Form::label('nro_memo', 'Nº memorándum') !!} {!! Form::number('nro_memo', $un->nro_memo, ['class' => 'form-control', 'min' => '1', 'max' => '9999']) !!}</div>
            <div class="col-md-4">{!! Form::label('fecha_informe', 'Fecha') !!} {!! Form::date('fecha_informe', $un->fecha_informe, ['class' => 'form-control']) !!}</div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-md-12"><label for="">COFINANCIAMIENTO DEL PRPA</label></div>
        </div>
        <div class="row">
