{!!Form::model($expediente,['id'=>'FormObservaExpedienteUaj', 'method'=>'POST', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['uaj.procesa-observacion',$expediente->id]])!!}
...
<div class="modal-body">
    ...
    <div id="ObservaExpedienteUajAlerts" class="alert alert-danger" style="display: none;"></div>
    {{-- Panel para mostrar alertas --}}
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-4">{!! Form::label('nro_informe', 'Nº de informe') !!} {!! Form::number('nro_informe', $uaj->nro_carta_archivo, ['class' => 'form-control']) !!}</div>
            <div class="col-md-4">{!! Form::label('fecha_informe', 'Fecha de informe') !!} {!! Form::date('fecha_informe', $uaj->fecha_carta_archivo, ['class' => 'form-control', 'max' => date('Y-m-d')]) !!}</div>
        </div>
    </div>
</div>
<div class="modal-footer">
    <div id="Footer_ObservaExpedienteUaj_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnObservaExpedienteUaj" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_ObservaExpedienteUaj_Disabled" style="display:none;">
