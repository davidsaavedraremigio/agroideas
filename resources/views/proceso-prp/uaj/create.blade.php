{!! Form::open(array('id'=>'FormCreateExpedienteUaj','url'=>'proceso-prp/uaj','method'=>'POST','autocomplete'=>'off')) !!}
...
<div class="modal-body">
    ...
    {!! Form::hidden('codigo', $uaj->id, ['class' => 'form-control']) !!}
    {{-- Panel para mostrar alertas --}}
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12"><label for="">DATOS DE RECEPCIÓN DEL EXPEDIENTE</label></div>
        </div>
        <div class="row">
            <div class="col-md-4">{!! Form::label('fecha_recepcion', 'Fecha de recepción') !!} {!! Form::date('fecha_recepcion', $uaj->fechaRecepcion, ['class' => 'form-control']) !!}</div>
...
<div class="modal-footer justify-content-between">
    <div id="Footer_CreateExpedienteUaj_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnCreateExpedienteUaj" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_CreateExpedienteUaj_Disabled" style="display:none;">
