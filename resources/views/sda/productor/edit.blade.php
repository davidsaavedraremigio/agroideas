{!!Form::model($productor,['id'=>'FormUpdateProductorSda', 'method'=>'PATCH', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['productor.update',$productor->id]])!!}
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-4">{!! Form::label('nro_ha', 'Nº de Ha') !!} {!! Form::text('nro_ha', $productor->nroHa, ['class' => 'form-control']) !!}</div>
            <div class="col-md-4">{!! Form::label('aporte', 'Aporte (S/)') !!} {!! Form::text('aporte', number_format($productor->aporte,2,'.',''), ['class' => 'form-control']) !!}</div>
        </div>
    </div>
</div>
</div>
<div class="modal-footer justify-content-between">
    <div id="Footer_UpdateProductorSda_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnUpdateProductorSda" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_UpdateProductorSda_Disabled" style="display:none;">
