{!!Form::model($expediente,['id'=>'FormArchivaSdaUr', 'method'=>'POST', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['admision.procesa-archivo',$expediente->id]])!!}
<div class="modal-header">
    <h4 class="modal-title">Declarar improcedencia</h4>
...
<div class="modal-body">
    ...
    <div id="ArchivaSdaUrAlerts" class="alert alert-danger" style="display: none;"></div>
    {{-- Panel para mostrar alertas --}}
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12"><label for="">III. CARTA QUE NOTIFICA LA IMPROCEDENCIA DEL EXPEDIENTE</label></div>
        </div>
        <div class="row">
            <div class="col-md-4">{!! Form::label('nro_carta', 'Nº de carta') !!} {!! Form::number('nro_carta', $ur->nro_carta_archivamiento, ['class' => 'form-control', 'min' => '1', 'max' => '9999']) !!}</div>
            <div class="col-md-4">{!! Form::label('fecha_carta', 'Fecha') !!} {!! Form::date('fecha_carta', $ur->fecha_carta_archivamiento, ['class' => 'form-control', 'max' => date('Y-m-d')]) !!}</div>
...
<div class="modal-footer">
    <div id="Footer_ArchivaSdaUr_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnArchivaSdaUr" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_ArchivaSdaUr_Disabled" style="display:none;">
