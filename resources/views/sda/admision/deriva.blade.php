{!!Form::model($expediente,['id'=>'FormDerivaSdaUr', 'method'=>'POST', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['admision.procesa-derivacion',$expediente->id]])!!}
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12"><label for="">III. VISTO BUENO FABORABLE</label></div>
        </div>
        <div class="row">
            <div class="col-md-4">{!! Form::label('nro_carta', 'Nº de carta') !!} {!! Form::number('nro_carta', $ur->nro_carta_aprobacion, ['class' => 'form-control', 'min' => '1', 'max' => '9999']) !!}</div>
            <div class="col-md-4">{!! Form::label('fecha_carta', 'Fecha de carta') !!} {!! Form::date('fecha_carta', $ur->fecha_carta_aprobacion, ['class' => 'form-control', 'max' => date('Y-m-d')]) !!}</div>
...
<div class="modal-footer justify-content-between">
    <div id="Footer_DerivaSdaUr_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnDerivaSdaUr" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_DerivaSdaUr_Disabled" style="display:none;">
