{!!Form::model($expediente,['id'=>'FormObservaExpedienteUn', 'method'=>'POST', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['evaluacion.procesa-observacion',$expediente->id]])!!}
<div class="modal-header">
    <h4 class="modal-title">Formulario para realizar observaciones al expediente Nº {{$expediente->nroExpediente}}</h4>
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-4">{!! Form::label('nro_memo', 'Nº de memorándum') !!} {!! Form::number('nro_memo', $un->nro_memo_observa, ['class' => 'form-control', 'min' => '1', 'max' => '9999']) !!}</div>
            <div class="col-md-4">{!! Form::label('fecha_memo', 'Fecha de memorándum') !!} {!! Form::date('fecha_memo', $un->fecha_memo_observa, ['class' => 'form-control', 'max' => date('Y-m-d')]) !!}</div>
...
<div class="modal-footer">
    <div id="Footer_ObservaExpedienteUn_Enabled">
        ...
        <a href="#" id="btnObservaExpedienteUn" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
