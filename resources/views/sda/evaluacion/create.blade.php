{!!Form::model($expediente,['id'=>'FormCreateExpedienteUn', 'method'=>'POST', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['evaluacion.update',$expediente->id]])!!}
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-4">{!! Form::label('fecha_recepcion', 'Fecha de recepción') !!} {!! Form::date('fecha_recepcion', $un->fecha_recepcion, ['class' => 'form-control']) !!}</div>
