...
@section('title', 'Módulo para la gestión de información de Solicitudes de apoyo (SDA)')
@section('content')
        ...
        <div class="card card-default color-palette-box">
            <div class="card-header bg-primary">
                ...
                <div class="card-tools">
                    <a href="proyecto/create" class="btn btn-sm btn-info" title="Registre un nuevo Proyecto"><i class="fas fa-plus-circle"></i><span> Añadir nuevo</span></a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            $("#viewDataProyecto").load("proyecto/data");
        });
    </script>
@stop