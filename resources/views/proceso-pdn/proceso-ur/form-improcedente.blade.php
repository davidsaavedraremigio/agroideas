{!! Form::open(array('id'=>'FormDesapruebaExpediente','url'=>'proceso-pdn/proceso-ur/improcedente','method'=>'POST','autocomplete'=>'off')) !!}
<div class="modal-header">
    <h4 class="modal-title">Declarar improcedente un expediente</h4>
...
<div class="modal-body">
    ...
    <div id="DesapruebaExpedienteAlerts" class="alert alert-danger" style="display: none;"></div>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12">{!! Form::label('observaciones', 'Motivo por el que se declara la improcedencia del expediente') !!} {!! Form::textarea('observaciones', '', ['class' => 'form-control', 'cols' => '2', 'rows' => '2']) !!}</div>
        </div>
    </div>
</div>
<div class="modal-footer justify-content-between">
    <div id="Footer_DesapruebaExpediente_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnDesapruebaExpediente" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_DesapruebaExpediente_Disabled" style="display:none;">
