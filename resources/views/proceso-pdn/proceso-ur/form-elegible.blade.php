{!! Form::open(array('id'=>'FormApruebaExpediente','url'=>'proceso-pdn/proceso-ur/elegible','method'=>'POST','autocomplete'=>'off')) !!}
<div class="modal-header">
    <h4 class="modal-title">Declarar elegibilidad a expediente</h4>
...
<div class="modal-body">
    ...
    <div id="ApruebaExpedienteAlerts" class="alert alert-danger" style="display: none;"></div>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12">{!! Form::label('observaciones', 'Principales motivos por los cuales se declara elegible a este expediente') !!} {!! Form::textarea('observaciones', '', ['class' => 'form-control', 'cols' => '2', 'rows' => '2']) !!}</div>
        </div>
    </div>
</div>
<div class="modal-footer justify-content-between">
    <div id="Footer_ApruebaExpediente_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnApruebaExpediente" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_ApruebaExpediente_Disabled" style="display:none;">
