...
@section('title', 'Módulo para el registro de expedientes')
@section('content')
            ...
            <div class="card-body">
                <div class="tab-content" id="TabExpedienteContent">
                    <div class="tab-pane fade show active" id="custom-tabs-expediente" role="tabpanel" aria-labelledby="TabExpediente001">
                        {!!Form::open(array('id'=>'FormCreateExpediente','url'=>'proceso-pdn/admision','method'=>'POST','autocomplete'=>'off', 'files' => 'true', 'enctype' => 'multipart/form-data'))!!}
                        {{Form::token()}}
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-2">{!! Form::label('ruc', 'Nº de RUC') !!} {!! Form::text('ruc', '', ['class' => 'form-control', 'placeholder' => '00000000000', 'id' => 'input_nro_documento']) !!}</div>
                                ...
                                <div class="col-md-6">{!! Form::label('razon_social', 'Razon social') !!} {!! Form::text('razon_social', '', ['class' => 'form-control', 'readonly' => 'readonly', 'id' => 'input_nombre']) !!}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-2">{!! Form::label('fecha_rrpp', 'Fecha RRPP') !!} {!! Form::date('fecha_rrpp', '', ['class' => 'form-control', 'id' => 'input_fecha_rrpp', 'readonly' => 'readonly']) !!}</div>
                                <div class="col-md-2">{!! Form::label('ubigeo', 'Ubigeo') !!} {!! Form::text('ubigeo', '', ['class' => 'form-control', 'id' => 'input_ubigeo', 'readonly' => 'readonly']) !!}</div>
                                <div class="col-md-2">{!! Form::label('estado_sunat', 'Estado SUNAT') !!} {!! Form::text('estado_sunat', '', ['class' => 'form-control', 'id' => 'input_estado_contribuyente', 'readonly' => 'readonly']) !!}</div>
                                <div class="col-md-6">{!! Form::label('direccion', 'Dirección registrada en SUNAT') !!} {!! Form::text('direccion', '', ['class' => 'form-control', 'id' => 'input_direccion', 'readonly' => 'readonly']) !!}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-3">{!! Form::label('nro_cut', 'Nº de CUT') !!} {!! Form::number('nro_cut', '', ['class' => 'form-control', 'min' => '1', 'max' => '9999']) !!}</div>
                                <div class="col-md-3">{!! Form::label('fecha_cut', 'Fecha') !!} {!! Form::date('fecha_cut', '', ['class' => 'form-control']) !!}</div>
                                <div class="col-md-3">{!! Form::label('nro_expediente', 'Nº de Expediente') !!} {!! Form::number('nro_expediente', '', ['class' => 'form-control', 'min' => '1', 'max' => '9999']) !!}</div>
                                <div class="col-md-3">{!! Form::label('fecha_expediente', 'Fecha') !!} {!! Form::date('fecha_expediente', '', ['class' => 'form-control']) !!}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div id="Footer_CreateExpediente_Enabled">
                                       <a href="#" id="btnCreateExpediente" class="btn btn-sm btn-primary"><i class="fas fa-save"></i> Guardar cambios</a>
                                       <a href="{{ env('APP_URL') }}/proceso-pdn/admision" class="btn btn-sm btn-default"><i class="fas fa-sign-out-alt"></i> Cerrar formulario</a>
                                   </div>
                                   <div id="Footer_CreateExpediente_Disabled" style="display:none;">
...
<script>
    $(document).ready(function () {
        ...
        $(document).on("click", '#btnCreateExpediente', function (event) {
            event.preventDefault();
            var form = $("#FormCreateExpediente");
            ...
            $.ajax({
                ...
                processData: false,
                beforeSend: function () {
                    $("#Footer_CreateExpediente_Enabled").css("display", "none");
                    $("#Footer_CreateExopediente_Disabled").css("display", "block");
                },
                success: function (response) {
                    ...
                    $("#Footer_CreateExpediente_Enabled").css("display", "block");
                    $("#Footer_CreateExpediente_Disabled").css("display", "none");
