{!!Form::model($indicador,['id'=>'FormUpdateIndicadorActividad', 'method'=>'PATCH', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['indicador-actividad.update',$indicador->id]])!!}
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12">{!! Form::label('descripcion', 'Descripción del indicador') !!} {!! Form::textarea('descripcion', $indicador->descripcion, ['class' => 'form-control', 'placeholder' => 'Descripcion del indicador', 'rows' => '2', 'cols' => '2']) !!} </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
...
<div class="modal-footer justify-content-between">
    <div id="Footer_UpdateIndicadorActividad_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnUpdateIndicadorActividad" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_UpdateIndicadorActividad_Disabled" style="display:none;">
