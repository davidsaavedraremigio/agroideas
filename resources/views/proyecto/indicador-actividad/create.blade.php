{!! Form::open(array('id'=>'FormCreateIndicadorActividad','url'=>'proyecto/indicador-actividad','method'=>'POST','autocomplete'=>'off')) !!}
...
<div class="modal-body">
    ...
    <div id="IndicadorActividadAlerts" class="alert alert-danger" style="display: none;"></div>
    {{-- Panel para mostrar alertas --}}
    <div class="form-group">
        <div class="row">
            <div class="col-md-4">{!! Form::label('codigo', 'Codigo') !!} {!! Form::text('codigo', '', ['class' => 'form-control', 'placeholder' => 'A-']) !!}</div>
            <div class="col-md-8">{!! Form::label('actividad', 'Seleccionar Actividad') !!}
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12">{!! Form::label('descripcion', 'Descripción del indicador') !!} {!! Form::textarea('descripcion', '', ['class' => 'form-control', 'placeholder' => 'Descripcion del indicador', 'rows' => '2', 'cols' => '2']) !!}</div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
...
<div class="modal-footer justify-content-between">
    <div id="Footer_CreateIndicadorActividad_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnCreateIndicadorActividad" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_CreateIndicadorActividad_Disabled" style="display:none;">
