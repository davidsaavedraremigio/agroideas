{!! Form::open(array('id'=>'FormCreateComponente','url'=>'proyecto/resultado','method'=>'POST','autocomplete'=>'off')) !!}
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">{!! Form::label('descripcion', 'Descripción del componente') !!} {!! Form::text('descripcion', '', ['class' => 'form-control', 'placeholder' => 'Descripción del componente / resultado']) !!}</div>
        </div>
    </div>
</div>
