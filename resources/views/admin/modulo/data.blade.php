<table id="TablaModulo" class="table table-striped table-bordered">
    <thead>
        <tr>
    ...
    <tbody>
        @foreach ($modulos as $keyNumber => $fila)
        <tr>
            ...
            <td class="text-center">
                <a href="#" class="btn btn-sm btn-warning" id="btnmodalUpdateModulo" data-toggle="modal" data-target="#modalUpdateModulo" data-id="{{$fila->id}}"><i class="fas fa-edit"></i></a>
                <a href="#" class="btn btn-sm btn-danger btnDeleteModulo" title="Eliminar registro" data-id="{{$fila->id}}"><i class="fas fa-trash-alt"></i></a>
            </td>
        </tr>    
        @endforeach
    </tbody>
