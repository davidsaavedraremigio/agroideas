{!!Form::model($productor,['id'=>'FormUpdateProductor', 'method'=>'PATCH', 'files' => 'true', 'enctype' => 'multipart/form-data', 'route'=>['socio.update',$productor->id]])!!}
...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-4">{!! Form::label('nro_documento', 'Nro. DNI') !!} {!! Form::text('nro_documento', $persona->dni, ['class' => 'form-control', 'placeholder' => '00000000', 'id' => 'input_nro_dni']) !!}</div>
            <div class="col-md-4">{!! Form::label('fecha', 'Fecha de nacimiento') !!} {!! Form::date('fecha', $persona->fechaNacimiento, ['class' => 'form-control', 'placeholder' => 'yyyy-mm-dd', 'min' => $minDate, 'max' => $maxDate]) !!}</div>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-4">{!! Form::label('nro_ha_solicitada', 'Área a reconvertir (ha) ') !!} {!! Form::text('nro_ha_solicitada', $productor->nroHaSolicitaReconvertir, ['class' => 'form-control']) !!}</div>
            <div class="col-md-4">{!! Form::label('nro_ha', 'Área total (ha)') !!} {!! Form::text('nro_ha', $productor->nroHaPropiedad, ['class' => 'form-control']) !!}</div>
        </div>
    </div>
</div>
</div>
<div class="modal-footer justify-content-between">
    <div id="Footer_UpdateProductor_Enabled">
        <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-sign-out-alt"></i> Cerrar</button>
        <a href="#" id="btnUpdateProductor" class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Guardar cambios</a>
    </div>
    <div id="Footer_UpdateProductor_Disabled" style="display:none;">
