<table id="TablaProductor" class="table table-bordered table-striped table-sm">
    <thead class="bg-primary">
        <tr>
            ...
            <th class="text-center"><small>Área a reconvertir</small></th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <a href="#" class="btn btn-sm btn-warning" id="btnmodalUpdateProductor" data-toggle="modal" data-target="#modalUpdateProductor" data-id="{{$fila->id}}"><i class="fas fa-edit"></i></a>
                <a href="#" class="btn btn-sm btn-danger btnDeleteProductor" title="Eliminar registro" data-id="{{$fila->id}}"><i class="fas fa-trash-alt"></i></a>
            </td>
        </tr>    
        @endforeach
    </tbody>
