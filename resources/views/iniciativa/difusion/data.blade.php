<table id="TablaDifusion" class="table table-striped table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><small>{{($fila->codTipo == 1)?'Evento presencial':'Evento virtual'}}</small></td>
            ...
            <td class="text-center"><small>{{$fila->nro_participantes}}</small></td>
            ...
            <td class="text-center">
                @if ($fila->codEstado == 1)
                <a href="{{URL::action('DifusionController@edit',$fila->id)}}" class="btn btn-sm btn-warning" title="Actualizar registro"><i class="fas fa-calendar-day"></i></a> 
                @endif
