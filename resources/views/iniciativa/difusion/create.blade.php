...
@section('title', 'Programar evento de promoción y difusión')
@section('content')
            ...
            <div class="card-body">
                <div class="tab-content" id="TabEventoContent">
                    <div class="tab-pane fade show active" id="custom-tabs-evento" role="tabpanel" aria-labelledby="TabEvento001">
                        {!!Form::open(array('id'=>'FormCreateDifusion','url'=>'iniciativa/difusion','method'=>'POST','autocomplete'=>'off', 'files' => 'true', 'enctype' => 'multipart/form-data'))!!}
                        {{Form::token()}}
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">{!! Form::label('nombre', 'Nombre del evento') !!} {!! Form::text('nombre', '', ['class' => 'form-control']) !!}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div id="Footer_CreateDifusion_Enabled">
                                       <a href="#" id="btnCreateDifusion" class="btn btn-sm btn-primary"><i class="fas fa-save"></i> Guardar cambios</a>
                                       <a href="{{ env('APP_URL') }}/iniciativa/difusion" class="btn btn-sm btn-default"><i class="fas fa-sign-out-alt"></i> Cerrar formulario</a>
                                   </div>
                                   <div id="Footer_CreateDifusion_Disabled" style="display:none;">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            $(document).on("click", '#btnCreateDifusion', function (event) {
                event.preventDefault();
                var form = $("#FormCreateDifusion");
                ...
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: function () {
                        $("#Footer_CreateDifusion_Enabled").css("display", "none");
                        $("#Footer_CreateDifusion_Disabled").css("display", "block");
                    },
                    success: function (response) {
                        ...
                        $("#Footer_CreateDifusion_Enabled").css("display", "block");
                        $("#Footer_CreateDifusion_Disabled").css("display", "none");
